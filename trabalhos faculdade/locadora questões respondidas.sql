...
/* 14. Mostra todos os filmes lançados em um ano diferente de 2018. */
...
select * from filmes 
where classificacao = 'livre' or classificacao = '10' or classificacao = '12'
...
select * from filmes
where genero = 'animacao' or genero = 'terror'
order by genero;
...
/* 27. Mostra os filmes com a letra "m" como segundo caracter do títilo. Foi utilizado 1 sublinhado.*/
select titulo, ano from filmes 
...
select genero, titulo from filmes;
...
select count(titulo) as filmes_disponiveis from filmes;

/* 33. Mostra a quantidade de titulos do gênero "Animação". */
select count(genero) as filmes from filmes 
